...
```json
{
  "projectName" : "node-express-accelerator",
  "includeTap" : true
}
```
## Log
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [node-express->node-express-acceler...(truncated)]
...
┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.transformations[0].sources[5] (Provenance)
